          ...
          for (k = 0; k < nz; k++)
            {
              ...
              if ((argc == 4) && (success == 1))
                { // we compute also Tmunu in the Landau frame
                  ...
                  // we save the informations about the number of particles and the grid
                  // size because, for a few bytes more of disk space, we can perform a
                  // consistency check when averaging
