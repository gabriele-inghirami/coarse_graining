	...
	for(k=k_start;k<k_end;k++)					
          {
            ...
            for(p=0;p<np;p++) 
              {
                for(l=0;l<10;l++) Tp2[l+TLOC2]=Tp[l+TLOC];
              }
	...
	for(k=k_start;k<k_end;k++)					
          {
            ...
            for(p=0;p<np;p++) 
              {
                for(l=0;l<4;l++)  Jp2[l+JPL2]=Jp[l+JPL];
              }
...
for(i=i_start;i<i_end;i++)
  {
	...
	for(k=k_start;k<k_end;k++)					
          {
            k2=k-k_start; //offset along k
            for(l=0;l<4;l++)  Jb2[l+JBL2]=Jb[l+JBL];
...
for(i=i_start;i<i_end;i++)
  {
	...
	for(k=k_start;k<k_end;k++)					
          {
            k2=k-k_start; //offset along k
            for(l=0;l<4;l++)  Jc2[l+JBL2]=Jc[l+JBL];
...
for(i=i_start;i<i_end;i++)
  {
	...
	for(k=k_start;k<k_end;k++)					
          {
            k2=k-k_start; //offset along k
            for(l=0;l<4;l++)  Js2[l+JBL2]=Js[l+JBL];
...
for(i=i_start;i<i_end;i++)
  {
	...
	for(k=k_start;k<k_end;k++)					
          {
            k2=k-k_start; //offset along k
            for(l=0;l<4;l++)  Jt2[l+JBL2]=Jt[l+JBL];
...
for(i=i_start;i<i_end;i++)
  {
	...
	for(k=k_start;k<k_end;k++)					
          {
            k2=k-k_start; //offset along k
            for(p=0;p<np;p++) Pnum2[PNLOC2]=Pnum[PNLOC];
